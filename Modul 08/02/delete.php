...
if (isset($_GET['id'])) {
    ...
    $stmt = $koneksi->prepare('SELECT kelas_mahasiswa.id_kelas, kelas_mahasiswa.id_mahasiswa, mahasiswa.nama, mahasiswa.nim FROM kelas_mahasiswa, mahasiswa WHERE mahasiswa.id_mahasiswa = kelas_mahasiswa.id_mahasiswa AND kelas_mahasiswa.id_kelas = :id');
    ...
    if ($kelases) {
        exit('Kelas tidak dapat dihapus dikarenakan ada mahasiswa yang mengambil kelas ini');
    }
