    ...
    <div class="container">
        ...
        <h1>Tabel Tinggi Permukaan Air</h1>
            ...
            <tbody>
                <?php
                    foreach($rows as $row){
                        echo "<tr><td>$row[id_tma]</td><td>$row[nilai]</td><td>$row[waktu]</td><td>
                        <button type=\"button\" class=\"infone btn btn-primary\">Info</button>
                        <button type=\"button\" class=\"delete btn btn-danger\" id=\"$row[id_tma]\" data-id=\"$row[id_tma]\">Delete</button></td>";
                    }
                    ?>
            </tbody>
        </table>
