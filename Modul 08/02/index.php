	...
	<table>
        ...
        <tbody>
            ...
            foreach ($kelases as $kelas){
                ...
                echo "<td class=\"actions\"><a href=\"kelas_mhs.php?id=$kelas[id_kelas]\" class=\"add\"><i class=\"fas fa-user-plus fa-xs\"></i></a>
                <a href=\"update.php?id=$kelas[id_kelas]\" class=\"edit\"><i class=\"fas fa-pen fa-xs\"></i></a>
                <a href=\"delete.php?id=$kelas[id_kelas]\" class=\"trash\"><i class=\"fas fa-trash fa-xs\"></i></a></td>";
                echo"</tr>";
            }
                ?>
        </tbody>
